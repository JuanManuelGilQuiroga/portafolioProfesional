...
export function Footer() {
    ...
    return (
        <>
            <motion.div ref={ref} animate={{ opacity: isInView ? 1 : 0 }} initial={{ opacity: 0 }} transition={{ duration: 0.8, delay: .3 }} className="h-[35vh] flex flex-col justify-around items-center w-[70vw]" id='habilidades'>
