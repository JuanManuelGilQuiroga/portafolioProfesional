export function MisionYVision () {
    return (
        <div className="flex flex-row items-start justify-between w-[70vw] h-[35vh] mt-[20vh]" id="objetivos">
            <div className="flex flex-col justify-between items-center w-[30vw] gap-6">
